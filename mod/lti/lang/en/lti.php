...
$string['courseapps'] = 'External tools';
$string['courseappselectionmessage'] = 'Select tool(s) to launch from side navigation bar';
...
$string['placementmenulink_allowlearners'] = 'Visible to Students';
$string['placementmenulink_allowlearners_help'] = 'If unchecked, only teachers will see this navigation link.';
$string['placementmenulink_remove'] = 'Remove';
