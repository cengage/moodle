...
class gradebookservices extends service_base {
     ...
     * @param string $resourceid The resourceid to apply to the lineitem. Might be an empty string which will be stored as null.
     * @param string $tag The tag to apply to the lineitem. Might be an empty string which will be stored as null.
     *
     */
    public static function update_coupled_gradebookservices(object $ltiinstance,
        ...
        if ($ltiinstance && $ltiinstance->typeid) {
            ...
            if ($gradeitem) {
                $resourceid = empty(trim($resourceid)) ? null : $resourceid;
                $tag = empty(trim($tag)) ? null : $tag;
